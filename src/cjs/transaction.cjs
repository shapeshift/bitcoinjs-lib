...
const zip243 = __importStar(require('./zip243.cjs'));
const zip244 = __importStar(require('./zip244.cjs'));
...
class Transaction {
  ...
  hashForWitnessV0(inIndex, prevOutScript, value, hashType) {
    ...
    if (isZcashSapling) {
      bufferWriter.writeSlice(exports.ZERO); // hashJoinSplits
      bufferWriter.writeSlice(exports.ZERO); // hashShieldedSpends
      bufferWriter.writeSlice(exports.ZERO); // hashShieldedOutput
    }
