...
import { Transaction, varSliceSize, ZERO } from './transaction.js';

function getPrevoutsHash(tx: Transaction): Uint8Array {
...
function getSequenceHash(tx: Transaction): Uint8Array {
  if (tx.ins.length === 0) return ZERO;
...
function getOutputsHash(tx: Transaction): Uint8Array {
